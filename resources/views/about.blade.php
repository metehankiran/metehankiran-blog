    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div>
            <div class="rounded-xl border bg-card text-card-foreground shadow p-6">
                ...
                <p class="text-muted-foreground">I'm a passionate developer with over 5 years of experience in web
                    development. I love creating beautiful and functional applications that solve real-world problems. When
                    I'm not coding, you can find me exploring new technologies, writing technical articles, or contributing
        ...
        <div class="grid gap-6 md:grid-cols-3">
            <div class="rounded-xl border bg-card text-card-foreground shadow p-6 text-center"><svg
                    ...
                    class="lucide lucide-code w-8 h-8 mx-auto mb-2">
                    <polyline points="16 18 22 12 16 6"></polyline>
                    <polyline points="8 6 2 12 8 18"></polyline>
                </svg>
                <h3 class="font-semibold">Development</h3>
                <p class="text-sm text-muted-foreground">React, TypeScript, Node.js</p>
            </div>
            <div class="rounded-xl border bg-card text-card-foreground shadow p-6 text-center"><svg
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-palette w-8 h-8 mx-auto mb-2">
                ...
                <p class="text-sm text-muted-foreground">UI/UX, Figma, Tailwind</p>
            </div>
            <div class="rounded-xl border bg-card text-card-foreground shadow p-6 text-center"><svg
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-globe w-8 h-8 mx-auto mb-2">
